...
const Question = ({ type, mongoUserId, questionDetails }: Props) => {
  ...
  const groupedTags = questionDetails
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormControl className="mt-3.5">
                <Input
                  className="no-focus paragraph-regular background-light-700_dark-300 light-border-2 text-dark-300_light-700 min-h-[56px] border"
                  {...field}
                />
              </FormControl>
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormControl className="mt-3.5">
                <>
                  <Input
                    disabled={type === "edit" || field.value.length === 5}
                    className="no-focus paragraph-regular background-light-900_dark-300 light-border-2 text-dark-300_light-700 min-h-[56px] border"
